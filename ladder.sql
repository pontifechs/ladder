...
-- -----------------------------------------------------
-- Table `ladder_test`.`users`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`users` (
...
-- -----------------------------------------------------
-- Table `ladder_test`.`game_types`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`game_types` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `ladder_test`.`matches`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`matches` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_matches_game_types1`
    ...
    REFERENCES `ladder_test`.`game_types` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ladder_test`.`sets`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`sets` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_sets_matches`
    ...
    REFERENCES `ladder_test`.`matches` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ladder_test`.`games`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`games` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_games_sets1`
    FOREIGN KEY (`sets_id` )
    REFERENCES `ladder_test`.`sets` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ladder_test`.`game_scores`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`game_scores` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_game_scores_games1`
    ...
    REFERENCES `ladder_test`.`games` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_game_scores_users1`
    FOREIGN KEY (`users_id` )
    REFERENCES `ladder_test`.`users` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ladder_test`.`user_ratings`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ladder_test`.`user_ratings` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `game_types_id` INT UNSIGNED NOT NULL ,
  `users_id` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`) ,
